...
var wei, _ = new(big.Float).SetString("1000000000000000000")
...
func (e *ETHHTLCManager) Redeem(id []byte, preimage [32]byte) ([]byte, error) {
	...
	tx, err := e.htlcContract.Withdraw(auth, idArr, preimage)
		logger.Info("xxxxxxxxxxxxxx", "hash", tx.Hash())
